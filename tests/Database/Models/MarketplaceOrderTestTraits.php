...
trait MarketplaceOrderTestTraits
{
    ...
    public function test_marketplaceorder_event_external_line_id_filter()
    {
        try {
            $request = new Request(
                [
    ...
    public function test_marketplaceorder_event_provider_filter()
    {
        try {
            $request = new Request(
                [
    ...
    public function test_marketplaceorder_event_order_no_filter()
    {
        try {
            $request = new Request(
                [
