...
{
    public const NAME = 'marketplace-success-manager';

    public const LEVEL = 120;

    public const DESCRIPTION = 'Marketplace success manager role that is responsible from making the graphic ' .
                                'materials of the product nice and create a success story about related products. ';
