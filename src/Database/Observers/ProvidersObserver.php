...
class ProvidersObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Marketplace\Providers', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Marketplace\Providers', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Marketplace\Providers', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Marketplace\Providers', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Marketplace\Providers', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Marketplace\Providers', $model);
    }
