...
class ProductsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Marketplace\Products', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Marketplace\Products', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Marketplace\Products', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Marketplace\Products', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Marketplace\Products', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Marketplace\Products', $model);
    }
