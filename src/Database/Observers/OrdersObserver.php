...
class OrdersObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Marketplace\Orders', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\Marketplace\Orders', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Marketplace\Orders', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Marketplace\Orders', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\Marketplace\Orders', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Marketplace\Orders', $model);
    }
    ...
    {
        Events::fire('deleted:NextDeveloper\Marketplace\Orders', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Marketplace\Orders', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Marketplace\Orders', $model);
    }
