...
class MarketsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Marketplace\Markets', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Marketplace\Markets', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Marketplace\Markets', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Marketplace\Markets', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Marketplace\Markets', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Marketplace\Markets', $model);
    }
