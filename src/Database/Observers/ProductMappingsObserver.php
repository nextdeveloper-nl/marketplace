...
class ProductMappingsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Marketplace\ProductMappings', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Marketplace\ProductMappings', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Marketplace\ProductMappings', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Marketplace\ProductMappings', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Marketplace\ProductMappings', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Marketplace\ProductMappings', $model);
    }
