...
/**
 * Class OrderStatusHistoriesObserver
 *
...
class OrderStatusHistoriesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Marketplace\OrderStatusHistories', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Marketplace\OrderStatusHistories', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Marketplace\OrderStatusHistories', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Marketplace\OrderStatusHistories', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Marketplace\OrderStatusHistories', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Marketplace\OrderStatusHistories', $model);
    }
