...
class StatusMappingsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Marketplace\StatusMappings', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Marketplace\StatusMappings', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Marketplace\StatusMappings', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Marketplace\StatusMappings', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Marketplace\StatusMappings', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Marketplace\StatusMappings', $model);
    }
