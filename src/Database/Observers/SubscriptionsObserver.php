...
class SubscriptionsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Marketplace\Subscriptions', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Marketplace\Subscriptions', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Marketplace\Subscriptions', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Marketplace\Subscriptions', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Marketplace\Subscriptions', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Marketplace\Subscriptions', $model);
    }
