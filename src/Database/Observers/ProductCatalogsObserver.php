...
class ProductCatalogsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Marketplace\ProductCatalogs', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Marketplace\ProductCatalogs', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Marketplace\ProductCatalogs', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Marketplace\ProductCatalogs', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Marketplace\ProductCatalogs', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Marketplace\ProductCatalogs', $model);
    }
