...
class AccountsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Marketplace\Accounts', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\Marketplace\Accounts', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Marketplace\Accounts', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Marketplace\Accounts', $model);
    }
    ...
    public function updating(Model $model)
    {
        ...
        Events::fire('updating:NextDeveloper\Marketplace\Accounts', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\Marketplace\Accounts', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Marketplace\Accounts', $model);
    }
    ...
    {
        Events::fire('deleted:NextDeveloper\Marketplace\Accounts', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Marketplace\Accounts', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Marketplace\Accounts', $model);
    }
