...
use NextDeveloper\Marketplace\Database\Observers\ProductCatalogMappingsObserver;
use NextDeveloper\Commons\Database\Traits\UuidId;
use NextDeveloper\Commons\Common\Cache\Traits\CleanCache;
use NextDeveloper\Commons\Database\Traits\Taggable;

/**
 * ProductCatalogMappings model.
 *
 ...
 * @property string $external_catalog_id
 * @property \Carbon\Carbon $created_at
 * @property \Carbon\Carbon $updated_at
 * @property \Carbon\Carbon $deleted_at
 */
class ProductCatalogMappings extends Model
{
    ...
    protected $table = 'marketplace_product_catalog_mappings';
    ...
    public static function boot()
    {
        ...
        parent::observe(ProductCatalogMappingsObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('marketplace.scopes.marketplace_product_catalog_mappings');
