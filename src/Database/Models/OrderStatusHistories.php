...
use NextDeveloper\Marketplace\Database\Observers\OrderStatusHistoriesObserver;
use NextDeveloper\Commons\Database\Traits\UuidId;
use NextDeveloper\Commons\Common\Cache\Traits\CleanCache;
use NextDeveloper\Commons\Database\Traits\Taggable;

/**
 * OrderStatusHistories model.
 *
...
class OrderStatusHistories extends Model
{
    ...
    public static function boot()
    {
        ...
        parent::observe(OrderStatusHistoriesObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('marketplace.scopes.marketplace_order_status_history');
