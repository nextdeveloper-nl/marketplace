 ...
 */
class AbstractProductMappingsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(ProductMappings $model)
    {
    ...
    public function includeActions(ProductMappings $model)
    {
    ...
    public function includeMedia(ProductMappings $model)
    {
    ...
    public function includeSocialMedia(ProductMappings $model)
    {
    ...
    public function includeComments(ProductMappings $model)
    {
    ...
    public function includeVotes(ProductMappings $model)
    {
    ...
    public function includeMeta(ProductMappings $model)
    {
    ...
    public function includePhoneNumbers(ProductMappings $model)
    {
    ...
    public function includeAddresses(ProductMappings $model)
    {
