 ...
 */
class AbstractOrderStatusHistoriesTransformer extends AbstractTransformer
{
    ...
    public function includeStates(OrderStatusHistories $model)
    {
    ...
    public function includeActions(OrderStatusHistories $model)
    {
    ...
    public function includeMedia(OrderStatusHistories $model)
    {
    ...
    public function includeSocialMedia(OrderStatusHistories $model)
    {
    ...
    public function includeComments(OrderStatusHistories $model)
    {
    ...
    public function includeVotes(OrderStatusHistories $model)
    {
    ...
    public function includeMeta(OrderStatusHistories $model)
    {
    ...
    public function includePhoneNumbers(OrderStatusHistories $model)
    {
    ...
    public function includeAddresses(OrderStatusHistories $model)
    {
