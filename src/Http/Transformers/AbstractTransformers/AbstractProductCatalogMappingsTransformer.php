 ...
 */
class AbstractProductCatalogMappingsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(ProductCatalogMappings $model)
    {
    ...
    public function includeActions(ProductCatalogMappings $model)
    {
    ...
    public function includeMedia(ProductCatalogMappings $model)
    {
    ...
    public function includeSocialMedia(ProductCatalogMappings $model)
    {
    ...
    public function includeComments(ProductCatalogMappings $model)
    {
    ...
    public function includeVotes(ProductCatalogMappings $model)
    {
    ...
    public function includeMeta(ProductCatalogMappings $model)
    {
    ...
    public function includePhoneNumbers(ProductCatalogMappings $model)
    {
    ...
    public function includeAddresses(ProductCatalogMappings $model)
    {
