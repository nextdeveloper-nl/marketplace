...
class AbstractSubscriptionsTransformer extends AbstractTransformer
{
    ...
    public function transform(Subscriptions $model)
    {
        ...
        return $this->buildPayload(
            ...
            'subscription_starts_at'  =>  $model->subscription_starts_at ? $model->subscription_starts_at->toIso8601String() : null,
            'subscription_ends_at'  =>  $model->subscription_ends_at ? $model->subscription_ends_at->toIso8601String() : null,
