...
class AbstractMarketsTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(Markets $model)
    {
    ...
    public function includeSocialMedia(Markets $model)
    {
    ...
    public function includeComments(Markets $model)
    {
    ...
    public function includeVotes(Markets $model)
    {
    ...
    public function includeMeta(Markets $model)
    {
    ...
    public function includePhoneNumbers(Markets $model)
    {
    ...
    public function includeAddresses(Markets $model)
    {
