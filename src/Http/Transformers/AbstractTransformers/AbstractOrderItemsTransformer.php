 ...
 */
class AbstractOrderItemsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(OrderItems $model)
    {
    ...
    public function includeActions(OrderItems $model)
    {
    ...
    public function includeMedia(OrderItems $model)
    {
    ...
    public function includeSocialMedia(OrderItems $model)
    {
    ...
    public function includeComments(OrderItems $model)
    {
    ...
    public function includeVotes(OrderItems $model)
    {
    ...
    public function includeMeta(OrderItems $model)
    {
    ...
    public function includePhoneNumbers(OrderItems $model)
    {
    ...
    public function includeAddresses(OrderItems $model)
    {
