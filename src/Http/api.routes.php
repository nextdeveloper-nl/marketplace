    ...
    function () {
        Route::prefix('product-catalogs')->group(
            function () {
                ...
                Route::get('/{marketplace_product_catalogs}/{subObjects}', 'ProductCatalogs\ProductCatalogsController@subObjects');
        ...
        Route::prefix('products')->group(
            function () {
                ...
                Route::get('/{marketplace_products}/{subObjects}', 'Products\ProductsController@subObjects');
        ...
        Route::prefix('subscriptions')->group(
            function () {
                ...
                Route::get('/{marketplace_subscriptions}/{subObjects}', 'Subscriptions\SubscriptionsController@subObjects');
