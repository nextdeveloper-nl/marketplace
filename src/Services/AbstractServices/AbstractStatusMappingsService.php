...
/**
 * This class is responsible from managing the data for StatusMappings
 *
 * Class StatusMappingsService.
 *
...
class AbstractStatusMappingsService
{
    public static function get(StatusMappingsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new StatusMappingsQueryFilter($request);
        }
        ...
        $model = StatusMappings::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?StatusMappings
    {
        return StatusMappings::findByRef($ref);
    }

    public static function getActions()
    {
        $model = StatusMappings::class;
    ...
    {
        $object = StatusMappings::where('uuid', $objectId)->first();
     ...
     *
     * @param  $id
     * @return StatusMappings|null
     */
    public static function getById($id) : ?StatusMappings
    {
    ...
    {
        try {
            $obj = StatusMappings::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        Events::fire('created:NextDeveloper\Marketplace\StatusMappings', $model);
     ...
     */
    public static function updateRaw(array $data) : ?StatusMappings
    {
    ...
    {
        $model = StatusMappings::where('uuid', $id)->first();
        ...
        Events::fire('updated:NextDeveloper\Marketplace\StatusMappings', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\Marketplace\StatusMappings', $model);
