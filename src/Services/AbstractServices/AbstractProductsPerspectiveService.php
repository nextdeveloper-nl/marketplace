...
class AbstractProductsPerspectiveService
{
    public static function get(ProductsPerspectiveQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new ProductsPerspectiveQueryFilter($request);
        }
        ...
        $model = ProductsPerspective::filter($filter);
    ...
    {
        return ProductsPerspective::all();
    }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?ProductsPerspective
    {
        return ProductsPerspective::findByRef($ref);
    }

    public static function getActions()
    {
        $model = ProductsPerspective::class;
    ...
    {
        $object = ProductsPerspective::where('uuid', $objectId)->first();
     ...
     *
     * @param  $id
     * @return ProductsPerspective|null
     */
    public static function getById($id) : ?ProductsPerspective
    {
        return ProductsPerspective::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = ProductsPerspective::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        try {
            $model = ProductsPerspective::create($data);
        } catch(\Exception $e) {
            throw $e;
        }

        Events::fire('created:NextDeveloper\Marketplace\ProductsPerspective', $model);
     ...
     *
     * @param  array $data
     * @return ProductsPerspective
     */
    public static function updateRaw(array $data) : ?ProductsPerspective
    {
    ...
    {
        $model = ProductsPerspective::where('uuid', $id)->first();
        ...
        Events::fire('updating:NextDeveloper\Marketplace\ProductsPerspective', $model);
        ...
        Events::fire('updated:NextDeveloper\Marketplace\ProductsPerspective', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\Marketplace\ProductsPerspective', $model);
