...
/**
 * This class is responsible from managing the data for MarketsPerspective
 *
 * Class MarketsPerspectiveService.
 *
...
class AbstractMarketsPerspectiveService
{
    public static function get(MarketsPerspectiveQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new MarketsPerspectiveQueryFilter($request);
        }
        ...
        $model = MarketsPerspective::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?MarketsPerspective
    {
        return MarketsPerspective::findByRef($ref);
    }

    public static function getActions()
    {
        $model = MarketsPerspective::class;
    ...
    {
        $object = MarketsPerspective::where('uuid', $objectId)->first();
     ...
     *
     * @param  $id
     * @return MarketsPerspective|null
     */
    public static function getById($id) : ?MarketsPerspective
    {
        return MarketsPerspective::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = MarketsPerspective::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        try {
            $model = MarketsPerspective::create($data);
        } catch(\Exception $e) {
            throw $e;
        }

        Events::fire('created:NextDeveloper\Marketplace\MarketsPerspective', $model);
     ...
     *
     * @param  array $data
     * @return MarketsPerspective
     */
    public static function updateRaw(array $data) : ?MarketsPerspective
    {
    ...
    {
        $model = MarketsPerspective::where('uuid', $id)->first();
        ...
        Events::fire('updating:NextDeveloper\Marketplace\MarketsPerspective', $model);
        ...
        Events::fire('updated:NextDeveloper\Marketplace\MarketsPerspective', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\Marketplace\MarketsPerspective', $model);
