...
use NextDeveloper\Marketplace\Database\Filters\ProvidersQueryFilter;
...
class AbstractProvidersService
{
    public static function get(ProvidersQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new ProvidersQueryFilter($request);
        }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Providers
    {
        return Providers::findByRef($ref);
    }

    public static function getActions()
    {
        $model = Providers::class;
    ...
    {
        $object = Providers::where('uuid', $objectId)->first();
     ...
     */
    public static function getById($id) : ?Providers
    {
    ...
    {
        try {
            $obj = Providers::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        Events::fire('created:NextDeveloper\Marketplace\Providers', $model);
     ...
     * @return Providers
     */
    public static function updateRaw(array $data) : ?Providers
    {
    ...
    {
        $model = Providers::where('uuid', $id)->first();
        ...
        Events::fire('updated:NextDeveloper\Marketplace\Providers', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\Marketplace\Providers', $model);
