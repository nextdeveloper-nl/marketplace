...
class AbstractOrdersService
{
    public static function get(OrdersQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new OrdersQueryFilter($request);
        }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Orders
    {
    ...
    {
        $object = Orders::where('uuid', $objectId)->first();
     ...
     * @return Orders|null
     */
    public static function getById($id) : ?Orders
    {
    ...
    {
        try {
            $obj = Orders::where('uuid', $uuid)->first();
     ...
     * @return Orders
     */
    public static function updateRaw(array $data) : ?Orders
    {
    ...
    {
        $model = Orders::where('uuid', $id)->first();
