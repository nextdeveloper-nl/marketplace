...
/**
 * This class is responsible from managing the data for ProductMappings
 *
...
class AbstractProductMappingsService
{
    public static function get(ProductMappingsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new ProductMappingsQueryFilter($request);
        }
        ...
        $model = ProductMappings::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?ProductMappings
    {
        return ProductMappings::findByRef($ref);
    }

    public static function getActions()
    {
        $model = ProductMappings::class;
    ...
    {
        $object = ProductMappings::where('uuid', $objectId)->first();
     ...
     *
     * @param  $id
     * @return ProductMappings|null
     */
    public static function getById($id) : ?ProductMappings
    {
    ...
    {
        try {
            $obj = ProductMappings::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        Events::fire('created:NextDeveloper\Marketplace\ProductMappings', $model);
     ...
     */
    public static function updateRaw(array $data) : ?ProductMappings
    {
    ...
    {
        $model = ProductMappings::where('uuid', $id)->first();
        ...
        Events::fire('updated:NextDeveloper\Marketplace\ProductMappings', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\Marketplace\ProductMappings', $model);
