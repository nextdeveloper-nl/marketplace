...
/**
 * This class is responsible from managing the data for ProductCatalogMappings
 *
 * Class ProductCatalogMappingsService.
 *
...
class AbstractProductCatalogMappingsService
{
    public static function get(ProductCatalogMappingsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new ProductCatalogMappingsQueryFilter($request);
        }
        ...
        $model = ProductCatalogMappings::filter($filter);
    ...
    {
        return ProductCatalogMappings::all();
    }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?ProductCatalogMappings
    {
        return ProductCatalogMappings::findByRef($ref);
    }

    public static function getActions()
    {
        $model = ProductCatalogMappings::class;
    ...
    {
        $object = ProductCatalogMappings::where('uuid', $objectId)->first();
     ...
     *
     * @param  $id
     * @return ProductCatalogMappings|null
     */
    public static function getById($id) : ?ProductCatalogMappings
    {
    ...
    {
        try {
            $obj = ProductCatalogMappings::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        Events::fire('created:NextDeveloper\Marketplace\ProductCatalogMappings', $model);
     ...
     *
     * @param  array $data
     * @return ProductCatalogMappings
     */
    public static function updateRaw(array $data) : ?ProductCatalogMappings
    {
    ...
    {
        $model = ProductCatalogMappings::where('uuid', $id)->first();
        ...
        Events::fire('updated:NextDeveloper\Marketplace\ProductCatalogMappings', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\Marketplace\ProductCatalogMappings', $model);
